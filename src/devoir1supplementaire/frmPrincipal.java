...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnNbAnnees.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNbAnneesActionPerformed(evt);
            }
        });
...
//Déclaration des variables :
      ...
      double PrixStadeTT = 150000000;
      double NbAnnee = 0;
      double Diminution = 0.8;
      double total = 0;
        
//Début :       
        
           while (total <= PrixStadeTT)
        {
           
            total = total + Recette;
            
            Recette = Recette * Diminution;
            NbAnnee++;
        }
        
        
        
        lblNbSemaines.setText(NbAnnee + "années" );
...
//Début : 
            ...
            //Boucle des "x":  
                ...
                for(int j = 1 ; j <= i  ; j++)
                {
                    ...
                    String ligne = ligne + "x";//Ligne remplie
                
                }
                
                /**/           String ligne = null;
                         tblTriangle.setText(tblTriangle.getText() + ligne + "\n");
                }
...
//Début :
                if(txtNbBugs.getText().compareTo("")== 0)
                {
                    ...
                    JOptionPane.showMessageDialog(this,"Veuillez saisir un nombre de bug.");
                }
            else  if(txtNbAnnees.getText().compareTo("")== 0)
                {
                
                    JOptionPane.showMessageDialog(this,"Veuillez saisir un nombre d'année");
                }
            else
                { 
                    Bugfix=Integer.parseInt(txtNbBugs.getText()) * 0.04;
                if(Bugfix > 400)
                {
                ...
                if ((Integer.parseInt(txtNbAnnees.getText()) > 4))
                {
                    ...
                    int i=0;
                        NouvA =(Integer.parseInt(txtNbAnnees.getText()) - 4);
                ...
                while (i < NouvA)
                {
                    ...
                    double PrimeFinale= Bugfix + NbA;
                    
                    lblPrime.setText(String.valueOf("La prime est de:" + " "+ PrimeFinale + " " + "euros"));
                }
         
    }//GEN-LAST:event_btnCalculerPrimeMouseClicked

    private void btnNbAnneesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNbAnneesActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnNbAnneesActionPerformed
